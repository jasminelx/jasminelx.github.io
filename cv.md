  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <h1 class="display-4 fw-bold mb-2">Jasmine Lever</h1>
        <p class="text-body-secondary mb-5">
          <a href="mailto:jasminetlever@gmail.com">jasminetlever@gmail.com</a> ·
          <a href="https://www.linkedin.com/in/jasmine-lever">LinkedIn</a>
        </p>

        <h2 class="h3 fw-bold border-bottom border-dark border-2 pb-2 mb-4">Education</h2>

        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>King's College London — BSc Artificial Intelligence</strong>
        ...
        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Ponteland High School — GCSEs and A Levels</strong>
        ...
        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Volunteer Lead of Content and Communications — LI(ai)SE</strong>
          <span class="text-body-secondary">May 2026 – Present</span>
        </div>
        <ul class="mb-4">
        ...
        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Improv Lead — King's Players</strong>
        ...
        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Intern — CarbonTag</strong>
          <span class="text-body-secondary">June 2025 – August 2025</span>
        </div>
        <ul class="mb-4">
          <li>Built an MCP-based AI agent that auto-generated personalised carbon reports, cutting production time from an average of 3 hours to 10 minutes. Later showcased to investors.</li>
        </ul>

        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Front Line Placement — The Old Vic</strong>
        ...
        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Private Tutor — Self-employed</strong>
        ...
        <div class="d-flex justify-content-between flex-wrap mb-1">
          <strong>Young Leader Volunteer — Preppies Youth Theatre</strong>
